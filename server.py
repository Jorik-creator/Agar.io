...
colors_cells = [
    ...
    (254, 6, 178), (255, 211, 7), (216, 6, 254),
    (145, 255, 7), (7, 255, 182), (255, 6, 86), (147, 7, 255)
]
dots = {j: {'x': random.randint(20, 1980), 'y': random.randint(20, 1980),
            'color': colors_cells[random.randint(0, len(colors_cells)-1)]} for j in range(2)}
agrball = {j: {'x': random.randint(20, 1980), 'y': random.randint(20, 1980)}
            for j in range(2)}
all_users = {}
